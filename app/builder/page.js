  ...
  return (
    <div className="grid">
      ...
      <div className="card">
        ...
        >
          Choose each component. The cart on the right will update instantly
          with line-item pricing. Images below change as you pick different
          walls, bases and fixtures.
        </p>

        {renderSelect("Project Type", "showerType", products.showerTypes)}
        {renderSelect(
          "Wall System (BCI Prime)",
          "wallSystem",
          products.wallSystems
        )}
        ...
        <div style={{ marginTop: 8 }}>
          {renderSelect(
            ...
            "flooring",
            [{ id: "", name: "No LifeProof flooring" }].concat(
              products.flooring
            ),
            "id"
          )}
            ...
            >
              ...
              >
                <div
                  style={{
                    ...
                    opacity: 0.42,
                    background:
                      "radial-gradient(circle at top,#4b5563,#020617)",
                  }}
                />
                <div style={{ position: "relative", zIndex: 1 }}>
                  <div style={{ fontSize: "0.8rem", opacity: 0.9 }}>
                    {
                      products.wallSystems.find(
                        (w) => w.id === selection.wallSystem
                      )?.name
                    }
                  </div>
                  <div
              ...
              >
                ...
                >
                  ...
                  <br />
                  {
                    products.fixtures.find(
                      (f) => f.id === selection.fixture
                    )?.name
                  }
                </div>
                <div
                ...
                {selection.flooring && (
                  ...
                  >
                    ...
                    <br />
                    {
                      products.flooring.find(
                        (fl) => fl.id === selection.flooring
                      )?.name
                    }
                  </div>
                )}
        ...
        >
          <strong>Disclaimer:</strong> All pricing shown is for budgeting
          and concept only and may vary based on site conditions, final
          selections, structural changes, code requirements, and current
      ...
      <aside className="card">
        ...
        >
          This is what you or the homeowner review at the table. Every
          selection on the left appears here as a line item.
        </div>
        ...
        <div style={{ marginTop: 10 }}>
          ...
          >
            Sample finance estimate (120 months):{" "}
            <strong>{formatMoney(estPayment)}/mo</strong>
            <br />
            Final finance terms subject to credit approval and current
            lender programs.
          </div>
        </div>
        ...
        >
          Future upgrades here: PDF proposal, e-signatures, CRM
          integration, and calendar scheduling that can sync with your
          phone.
        </p>
      </aside>
    </div>
